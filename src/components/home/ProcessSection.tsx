    ...
    <section className="py-24 lg:py-32" id="process">
      <Container>
        ...
        >
          ...
          <div className="absolute top-12 left-[16.67%] right-[16.67%] hidden h-px bg-gradient-to-r from-graphite via-gold/30 to-graphite md:block" />
          ...
          {steps.map((step) => (
            ...
            >
              <div className="relative z-10 mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full border border-gold/20 bg-charcoal">
