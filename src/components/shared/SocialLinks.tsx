...
export const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 192 192" fill="currentColor" aria-hidden="true">
...
export function SocialLinks({
  ...
  const sizeClass = iconSize === "sm" ? "h-11 w-11" : "h-14 w-14";
    ...
    <div className={cn("flex flex-wrap items-center gap-3", className)}>
      {socialLinks.map((link) => (
        ...
        >
          ...
          <VerifiedTick size={showLabels ? 16 : 18} />
        </a>
      ))}
    </div>
  );
