  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full rounded-lg glass-input backdrop-blur-sm py-2.5 pl-10 pr-9 text-sm text-pearl placeholder:text-ash transition-colors focus:border-forest/50 focus:outline-none sm:w-64"
      />
      {hasValue && (
        <button
          type="button"
